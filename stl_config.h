...
#endif
#if (_COMPILER_VERSION < 721) || !defined(__STL_HAS_NAMESPACES) || \
...
// allocators as before, without having to edit library headers.
    ...
    defined(__STL_MEMBER_TEMPLATE_CLASSES) && !defined(__STL_NO_BOOL) && \
...
#if defined(__STL_CLASS_PARTIAL_SPECIALIZATION) && \
    defined(__STL_MEMBER_TEMPLATES) && !defined(_STL_NO_CONCEPT_CHECKS)
