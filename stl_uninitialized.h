...
inline _ForwardIter __uninitialized_copy_aux(_InputIter __first,
                                             _InputIter __last,
...
_ForwardIter __uninitialized_copy_aux(_InputIter __first, _InputIter __last,
  ...
  __STL_TRY {
    for (; __first != __last; ++__first, ++__cur) _Construct(&*__cur, *__first);
    return __cur;
  }
...
inline pair<_RandomAccessIter, _ForwardIter> __uninitialized_copy_n(
...
template <class _InputIter, class _Size, class _ForwardIter>
inline pair<_InputIter, _ForwardIter> __uninitialized_copy_n(
...
template <class _InputIter, class _Size, class _ForwardIter>
inline pair<_InputIter, _ForwardIter> uninitialized_copy_n(
    _InputIter __first, _Size __count, _ForwardIter __result) {
  return __uninitialized_copy_n(__first, __count, __result,
                                __ITERATOR_CATEGORY(__first));
}
...
void __uninitialized_fill_aux(_ForwardIter __first, _ForwardIter __last,
  ...
  __STL_TRY {
    for (; __cur != __last; ++__cur) _Construct(&*__cur, __x);
  }
...
_ForwardIter __uninitialized_fill_n_aux(_ForwardIter __first, _Size __n,
  ...
  _ForwardIter __cur = __first;
  __STL_TRY {
    for (; __n > 0; --__n, ++__cur) _Construct(&*__cur, __x);
    return __cur;
  }
  __STL_UNWIND(_Destroy(__first, __cur));
}
...
inline _ForwardIter __uninitialized_copy_copy(_InputIter1 __first1,
                                              _InputIter1 __last1,
...
inline _ForwardIter __uninitialized_fill_copy(_ForwardIter __result,
                                              _ForwardIter __mid,
                                              const _Tp& __x,
                                              _InputIter __first,
                                              _InputIter __last) {
